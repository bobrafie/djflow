...
var FLACTagContents = require('../FLACTagContents');

var FLACTagReader = require('../FLACTagReader');

describe("FLACTagReader", function () {
  var flacFileContents = new FLACTagContents([FLACTagContents.createCommentBlock(["TITLE", "A Title"], ["ARTIST", "An Artist"], ["ALBUM", "An Album"], ["TRACKNUMBER", "1"], ["GENRE", "A Genre"]), FLACTagContents.createPictureBlock()]);
  var mediaFileReader;
  var tagReader;
  beforeEach(function () {
