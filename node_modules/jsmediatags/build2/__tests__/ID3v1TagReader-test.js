...
describe("ID3v1TagReader", function () {
  it("reads 1.0 tags", function () {
    var id3ArrayFile = [].concat(bin("TAG"), pad(bin("Song Title"), 30), pad(bin("The Artist"), 30), pad(bin("The Album"), 30), bin("1995"), pad(bin("A Comment"), 30), 30);
  ...
  it("reads 1.1 tags", function () {
    var id3ArrayFile = [].concat(bin("TAG"), pad(bin("Song Title"), 30), pad(bin("The Artist"), 30), pad(bin("The Album"), 30), bin("1995"), pad(bin("A Comment"), 29), 3, 30);
    var mediaFileReader = new ArrayFileReader(id3ArrayFile);
    var tagReader = new ID3v1TagReader(mediaFileReader);
    return new Promise(function (resolve, reject) {
      tagReader.read({
