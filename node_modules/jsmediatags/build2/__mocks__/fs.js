...
var path = require.requireActual('path'); // Get the automatic mock for `fs`


var fsMock = jest.genMockFromModule('fs'); // This is a custom function that our tests can use during setup to specify
...
fsMock.stat.mockImplementation(stat); // Add a custom method to the mock
